...
"""Dispatcher for cable compare inputs."""
...
try:
    ...
    from .experiment_schema import config_to_payload, expand_cases, load_model_config, load_sweep_config
    from .outputs import (
        SUMMARY_METRICS,
    ...
    from experiment_schema import config_to_payload, expand_cases, load_model_config, load_sweep_config  # type: ignore
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--out-dir", help="Optional output directory for config runs.")
    parser.add_argument("--expand-only", action="store_true", help="Only expand sweep configs without running compare.")
...
def run_sweep_config(
    ...
    *,
    ...
    write_json(resolved_out_dir / "aggregate.json", aggregate)
